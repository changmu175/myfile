...
public class Callback {
  ...
  public void on_record_device_state(int state) {
    if (getClass() == Callback.class) pjsuaJNI.Callback_on_record_device_state(swigCPtr, this, state); else pjsuaJNI.Callback_on_record_device_stateSwigExplicitCallback(swigCPtr, this, state);
  }
