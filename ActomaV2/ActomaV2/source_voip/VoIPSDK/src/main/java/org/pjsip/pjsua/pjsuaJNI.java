...
public class pjsuaJNI {
  ...
  public final static native void Callback_on_record_device_state(long jarg1, Callback jarg1_, int jarg2);
  public final static native void Callback_on_record_device_stateSwigExplicitCallback(long jarg1, Callback jarg1_, int jarg2);
  ...
  public final static native void call_force_hangup_all();
  ...
  public final static native void AES128_init_secretkey(short[] jarg1, int jarg2);
  public final static native int pj_get_str_len(long jarg1, pj_str_t jarg1_);
  public final static native void pj_get_str(long jarg1, pj_str_t jarg1_, short[] jarg2);
  ...
  public static void SwigDirector_Callback_on_record_device_state(Callback self, int state) {
    self.on_record_device_state(state);
  }
