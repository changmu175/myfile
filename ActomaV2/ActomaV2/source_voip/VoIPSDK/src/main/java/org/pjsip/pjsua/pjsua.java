...
public class pjsua implements pjsuaConstants {
  ...
  public synchronized static void call_force_hangup_all() {
    pjsuaJNI.call_force_hangup_all();
  }
  ...
  public static void AES128_init_secretkey(short[] key, int on) {
    pjsuaJNI.AES128_init_secretkey(key, on);
  }

  public static int pj_get_str_len(pj_str_t str) {
    return pjsuaJNI.pj_get_str_len(pj_str_t.getCPtr(str), str);
  }

  public static void pj_get_str(pj_str_t str, short[] result) {
    pjsuaJNI.pj_get_str(pj_str_t.getCPtr(str), str, result);
  }
