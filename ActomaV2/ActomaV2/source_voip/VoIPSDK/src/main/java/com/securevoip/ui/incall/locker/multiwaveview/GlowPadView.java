...
package com.securevoip.ui.incall.locker.multiwaveview;
...
//    }
    ...
    private void dispatchTriggerEvent(int whichTarget) {
        ...
        if(mOnLeftRightListener != null) {
            LogUtil.getUtils(THIS_FILE).d("Target activated :: " + whichTarget);
            if(whichTarget == 0) {
    ...
    private String getTargetDescription(int index) {
        if (mTargetDescriptions == null || mTargetDescriptions.isEmpty()) {
            ...
            if (mTargetDrawables.size() != mTargetDescriptions.size()) {
                LogUtil.getUtils(THIS_FILE).w("The number of target drawables must be"
    ...
    public boolean replaceTargetDrawablesIfPresent(ComponentName component, String name,
        ...
        if (component != null) {
            try {
                ...
                LogUtil.getUtils(THIS_FILE).e("Failed to swap drawable; "
                        + component.flattenToShortString() + " not found", e);
            } catch (Resources.NotFoundException nfe) {
                LogUtil.getUtils(THIS_FILE).e("Failed to swap drawable from "
