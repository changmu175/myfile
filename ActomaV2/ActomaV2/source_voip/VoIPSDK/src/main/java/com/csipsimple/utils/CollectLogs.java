...
public class CollectLogs {
    ...
    @SuppressLint("FinalStaticMethod")
	public final static LogResult getLogs(Context ctxt) {
        ...
        try{
            ...
            LogUtil.getUtils(THIS_FILE).e("Collect logs failed : ", e);//$NON-NLS-1$
            log.append("Unable to get logs : ").append(e.toString());
        }
	...
	public final static StringBuilder getDeviceInfo() {
        ...
        log.append(LINE_SEPARATOR); 
        log.append("android.os.Build.BOARD : ").append(android.os.Build.BOARD);
        log.append(LINE_SEPARATOR); 
		log.append("android.os.Build.BRAND : ").append(android.os.Build.BRAND);
        log.append(LINE_SEPARATOR); 
		log.append("android.os.Build.DEVICE : ").append(android.os.Build.DEVICE);
        log.append(LINE_SEPARATOR); 
		log.append("android.os.Build.ID : ").append(android.os.Build.ID);
        log.append(LINE_SEPARATOR); 
		log.append("android.os.Build.MODEL : ").append(android.os.Build.MODEL);
        log.append(LINE_SEPARATOR); 
		log.append("android.os.Build.PRODUCT : ").append(android.os.Build.PRODUCT);
        log.append(LINE_SEPARATOR);
		log.append("android.os.Build.TAGS : ").append(android.os.Build.TAGS);
        log.append(LINE_SEPARATOR);
        log.append("android.os.Build.CPU_ABI : ").append(android.os.Build.CPU_ABI);
        log.append(LINE_SEPARATOR); 
		log.append("android.os.Build.VERSION.INCREMENTAL : ").append(android.os.Build.VERSION.INCREMENTAL);
        log.append(LINE_SEPARATOR); 
		log.append("android.os.Build.VERSION.RELEASE : ").append(android.os.Build.VERSION.RELEASE);
        log.append(LINE_SEPARATOR); 
		log.append("android.os.Build.VERSION.SDK_INT : ").append(android.os.Build.VERSION.SDK_INT);
        log.append(LINE_SEPARATOR); 
