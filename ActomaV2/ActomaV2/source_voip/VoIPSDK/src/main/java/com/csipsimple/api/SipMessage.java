...
public class SipMessage {
     ...
     * Uri for content provider of sip message
     */
    private static Uri messageUri = null;
    ...
    public boolean isOutgoing() {
		return (SipMessage.SELF.equalsIgnoreCase(from));
    }
    ...
    public static Uri getMessageUri(Context context) {
        if(messageUri == null || messageUri.equals(Uri.EMPTY)){
            if(context != null){
                messageUri = Uri.parse(ContentResolver.SCHEME_CONTENT
                        + "://" + DBProvider.getAuthority(context) + "/" + MESSAGES_TABLE_NAME);
            }else{
