...
public class PreferenceProvider extends ContentProvider {
	...
	public final static String AUTHORITY_SUFFIX = ".preferenceprovider";
	...
	public boolean onCreate() {
		...
		URI_MATCHER.addURI(getAuthority(getContext()), SipConfigManager.PREFS_TABLE_NAME, PREFS);
		URI_MATCHER.addURI(getAuthority(getContext()), SipConfigManager.PREFS_TABLE_NAME + "/*", PREF_ID);
		URI_MATCHER.addURI(getAuthority(getContext()), SipConfigManager.RESET_TABLE_NAME, RAZ);
		return true;
	}
		...
		if (URI_MATCHER.match(uri) == PREF_ID) {
			...
			if (TextUtils.isEmpty(selection)) {
				...
				try {
					...
					LogUtil.getUtils(THIS_FILE).e("Impossible to retrieve class from selection");
				}
			}
			Object value = null;
