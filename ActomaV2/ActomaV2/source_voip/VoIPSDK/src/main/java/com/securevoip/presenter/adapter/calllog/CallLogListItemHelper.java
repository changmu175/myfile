...
//        mTheme = Theme.getCurrentTheme(ctxt);
     ...
     */
    public void setPhoneCallDetails(CallLogListItemViews views, PhoneCallDetails details,Context mContext) {

        mPhoneCallDetailsHelper.setPhoneCallDetails(views.phoneCallDetailsViews, details,mContext);

        /*Drawable d = null;
        if(d == null) {
            views.secondaryActionView.setBackgroundResource(R.drawable.ic_ab_dialer_helo_dark);
        }else {
            views.secondaryActionView.setBackgroundDrawable(d);
        }
