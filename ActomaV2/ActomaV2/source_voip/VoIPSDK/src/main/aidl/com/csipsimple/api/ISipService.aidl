...
interface ISipService{
	...
	*/
    ...
    // self defined interface for account xjq
    void setMediaState(in MediaState mediaState);
	void addCustAccount(String serverAddr);
    void custAccountOnline();
	void custAccountOffline();
	void delCustAccount();
	...
	*/ 
	...
	// Interface for set hanging, over and incoming state. Add by xjq, 2015/2/26
	void setCallHangingState(int callId, boolean isHanging);
	void setCallOverState(int callId, boolean isOver);
	void setIncoming(int callId, boolean isIncoming);
	void setNoSnd();
	void setSnd();
	...
	*/
	 ...
	 */
	 ...
	 SipCallSession getPNCall(String callId);

	 void startRing(String contact);
	 void stopRing(String contact);

void stopPlaying(int callId);
