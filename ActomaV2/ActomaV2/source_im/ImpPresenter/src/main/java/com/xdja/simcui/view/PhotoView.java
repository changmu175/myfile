...
//            onUp(e2);
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
			//guorong 20161019 bug 4557. begin
            mapRect(mImgRect , mWidgetRect , outRectF);
            /*if((mImgRect.left > 0 && mImgRect.top > 0) || (mImgRect.bottom < mWidgetRect.height()
                    && mImgRect.right < mWidgetRect.width())){
                return false;
            }*/
            if(outRectF.width() < mWidgetRect.width() - 5 && outRectF.height() < mWidgetRect.height() - 5){
                return false;
            }
			//guorong 20161019 bug 4557. end
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            //isZoonUp = !isZoonUp;  //delete by gbc 20160916
    ...
    private boolean canScrollHorizontallySelf(float direction) {
        int daltX = 10;
        //delete by gbc. 20160916
        /*if (Math.round(mImgRect.width()) > mWidgetRect.width()) {
            return true;
        }*/
        //modify by gbc 20160916
        if (direction < 0 && mImgRect.left + daltX /*Math.round(mImgRect.left) - direction*/ < mWidgetRect.left) {
            return true;
        }
        //modify by gbc 20160916
        return direction > 0 && mImgRect.right - daltX/*Math.round(mImgRect.right) - direction*/ > mWidgetRect.right;
    }
    ...
    private void animaFrom(Info info) {
        if (isInit) {
            ...
            mTranslate.withTranslate((int) (mScreenCenter.x - ocx), (int) (mScreenCenter.y - ocy));
