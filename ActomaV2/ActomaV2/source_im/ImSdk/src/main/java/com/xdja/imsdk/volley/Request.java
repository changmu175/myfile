...
import com.xdja.imsdk.volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    /** Listener interface for progress update*/
    private Response.LoadingListener mLoadingListener;
    
    /** Listener interface for request canceled*/
    ...
    /** When network changed, rhe fail code wile be return */
     ...
     *
     * @deprecated Use {@link #Request(int, String, com.xdja.imsdk.volley.Response.ErrorListener)}.
     */
    @Deprecated
    ...
    /**
     * @return this request's {@link com.xdja.imsdk.volley.Response.ErrorListener}.
     */
     ...
     * @param message failed message detail
     */
    ...
    /**
     * Delivers loading message to the LoadingListener that the Request was
     * initialized with.
     * @param count the total upload or download file size.
     * @param translate the current translate size.
     */
    public void deliverLoading(long count, long translate) {
        if (mLoadingListener != null) {
            mLoadingListener.onLoading(count, translate);
        }
    }
    
    /**
     * Delivers when request canceled. 
     */
    public void deliverCanceled(){
    	if (mCanceledListener != null){
    		mCanceledListener.onCanceled();
    	}
    }
