...
public class VolleyLog {
    ...
    public static int LOG_LEVEL = Log.VERBOSE;//Log.VERBOSE(Debug), Log.ERROR(Release)

    public static boolean DEBUG = Log.isLoggable(TAG, Log.ERROR);
    ...
    static class MarkerLog {
        ...
        public synchronized void add(String name, long threadId) {
            if (mFinished) {
                VolleyLog.d("Marker added to finished log");
                return;
