...
package com.xdja.comm.zxing.scan.view;
...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			if (lineRect == null) {// modified by ycm for lint 2017/03/06
				lineRect = new Rect();
			}
			...
			BitmapDrawable bitmapDrawable = ((BitmapDrawable) (getResources().getDrawable(R.drawable.qr_scan_line)));
			Bitmap bitmap = null;
			if (bitmapDrawable != null) {// TODO: 2017/2/17 若为空，如何处理
